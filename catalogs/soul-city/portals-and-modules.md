...
| [Object shops](object-shops.md): jukebox, picture rig, backdrop, accessory manager | objects as containers; built with the pie menu tree editor and the ad editor |
