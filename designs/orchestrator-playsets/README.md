...
| **Cult Sims** *(proposed)* | **Television** (channels dispense ideology) | Broadcast controller — re-weights other objects' ads | [`cult-sims.md`](cult-sims.md) — bridges SimProv and Zombie Sims |
