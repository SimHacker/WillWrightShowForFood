...
| **Cult Sims** *(proposed)* | **SwagOMatic stand** (+ TV as demand side) | **Many hubs per lot** — one stand is one cult, competing for one hat slot | [`cult-sims.md`](cult-sims.md) — bridges SimProv and Zombie Sims |
