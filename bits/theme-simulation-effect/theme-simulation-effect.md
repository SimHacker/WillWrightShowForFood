...
Players narrate causal chains Will knows don't exist — and that gap *is* the show. Simple local rules produce global patterns the player reads as story. The simulation effect is not a bug in the microworld; it is the medium.

**Topic:** Player-as-author; local rules → global patterns; story as medium.

**Quote (the hook):** *"Players narrate causal chains Will knows don't exist."*
...
| Theme | Link |
|-------|------|
| Microworld morality | [../theme-microworld-morality/theme-microworld-morality.md](../theme-microworld-morality/theme-microworld-morality.md) — Cyberiad thread in the SimCity section |
| Data portability | [../theme-data-portability-crown-jewel/theme-data-portability-crown-jewel.md](../theme-data-portability-crown-jewel/theme-data-portability-crown-jewel.md) — the 1996 goal the effect hangs on |
| Procedural rhetoric | [../theme-procedural-rhetoric/theme-procedural-rhetoric.md](../theme-procedural-rhetoric/theme-procedural-rhetoric.md) — objects argue; players narrate |
