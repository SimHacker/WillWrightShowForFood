...
Respectful portrayal of public legacy and published work for Repo Show attribution.
`
		: `---
status: draft
character_id: ${slug}
...
We would respectfully invite **${meta.name}** to a **Repo Show** — a friendly recorded
