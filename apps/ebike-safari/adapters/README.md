# Device adapters — Ebike Safari ingest

The Ebike Safari pipeline converges on **FIT → web JSON**. Each device is a thin adapter
...
Design note (collaboration intent): [`design/sources/abraham-moller-xoss.md`](design/sources/abraham-moller-xoss.md)
