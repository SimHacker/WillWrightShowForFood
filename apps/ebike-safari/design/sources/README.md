# Design sources — slurp inbox

Reference material melted into [`../CAULDRON.yml`](../CAULDRON.yml).

| Source | File | Status |
|--------|------|--------|
| Amsterdam GPS lineage (iLoci → Coffeeshops → StoryMaker/Urban Safari) | [amsterdam-gps-lineage.md](amsterdam-gps-lineage.md) | in repo |
| TomTom rejected ideas (TomTomagotchi, speed LB, territory paint) | [tomtom-rejected-ideas.md](tomtom-rejected-ideas.md) | in repo |
| Urban garden loop (community garden / cooperate) | [../urban-garden-loop.md](../urban-garden-loop.md) | in repo |
