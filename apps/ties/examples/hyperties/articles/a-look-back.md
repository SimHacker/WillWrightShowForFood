...
title: A Look Back
synonyms:
  - Designing to Facilitate Browsing
  - Designing to Facilitate Browsing: A Look Back at the Hyperties Workstation Browser
  - look back
  - the 1991 paper
  - Hyperties workstation browser
definition: "Designing to Facilitate Browsing: A Look Back at the Hyperties Workstation Browser. Shneiderman, Plaisant, Botafogo, Hopkins, Weiland. Hypermedia 3(2), 1991, 101–117."
---
...
Published in *Hypermedia*, vol. 3, 2 (1991) 101–117.
...
When a user clicks once on the highlighted string "Faint object camera", the corresponding definition appears on the four line area reserved in the low part of the screen. A double click brings up the Full Article on that topic, replacing the current article.
When a link is selected with the right button (used to access all menus) a pie menu allows the selection of the window in which the new article should appear. See Section 3 for a description of the pie menu.
...
Figure 4: A schema illustrating the use of conditional links: Dotted links will only be active when all articles of Chapter One have been read.
...
Figure 7: a four window version with the Holocaust database and the target window selection box available.
...
13. Weiland, William and Shneiderman, Ben, Interactive Graphics Interfaces for Hypertext Systems, Proc. ACM DC Technical Symposium 1989, Washington DC (1989).
...
17. Guide for Macintosh, Owl International, Inc., 14218 NE 21st St., Bellevue, WA 98007, (1988).
