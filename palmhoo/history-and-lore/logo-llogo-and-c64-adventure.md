# Logo, LLogo, and C64 Adventure

*Two artifacts on one lineage shelf: Brian teaches Logo as curriculum; Don shipped Adventure
and rescued the lab implementation.*

## The pair

| Artifact | Who | What it proves |
|----------|-----|----------------|
...
[Snap! + Logo pair show](../../repo-shows/snap-logo-brian-jens/README.md) — Brian & Jens tell
Logo → Scheme → Snap!; Don's dossiers supply the **implementation** and **first commercial game**
beats.

↑ [History & Lore README](README.md) · [Constructionist trail](../../process/trails/constructionist-lineage.md)
