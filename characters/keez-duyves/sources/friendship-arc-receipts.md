# Friendship arc receipts — Don ↔ Keez Duyves (PIPS:lab)

*Evidence reminders for invite + show. Private phones, home addresses, and non-Keez employment detail stay out of this public repo.*
[Portrayal standards](../../../schemas/portrayal-standards.md)

## Not the other Amsterdam Keez

Don’s 1993 / 2000 / 2008 “Kees / kees colijn” friendship (Arthur van Hoff’s friend; first Amsterdam visit; post–The Sims reconnect) is a **different person**. Keez is a common Dutch name. That arc is filed in Don’s personal notes — not this room. Do not fuse.

## Confirmed — Keez Duyves / PIPS:lab

### ~2009 — first meet: **Trouw** performance

**Don’s memory (2026):** first met Keez at a **PIPS:lab performance at Trouw**, not at Canvas. **Ben Cerveny** may have been there too — verify with Ben/Keez.

**8 Jun 2009 mail** (Don → Paul Asmuth, “Re: Dude!”) — same week/scene, earliest dated write-up: café **Canvas** on the **Volkskrant** roof (across from Trouw); met PIPS:lab, who regularly performed at Trouw, just after their 10-year anniversary of live video performance art. (Original mail misspelled the venue; corrected here.)

| Link (as in mail) | Note |
|-------------------|------|
| http://www.trouwamsterdam.nl/en/ | **Trouw** — first-meet venue (performance) |
| http://www.canvasopde7e.nl/ | Canvas “on the 7th” — hangout / discovery write-up |
...
### 2012–13 — Unity / pie menus (Messenger)

World-from-data vs Island demo; pie menus in 3D; Keez: “a little inbetween gaffertape and messaging objects.”

### 7 Mar 2017 (approx.) — Anyways at NDSM lab

Don to Arthur van Hoff (Jaunt), 8 Mar 2017: *“Yesterday I met with Keez Duyves, of PIPS:LAB, and experienced his VR video for six people (although I was the only one, he set it up and orchestrated it so I could see what it was like).”* Called him *“an amazing genius computer artist who’s been doing 360 video for a long time”*; picked his brain on production/implementation; wanted Keez on Jaunt’s JavaScriptable 360 player.

**Place (Don memory):** **NDSM** studio. Mail doesn’t name NDSM; Don confirms. By then friends for years (Canvas 2009 → FB 2012 → …).

| Asset | URL |
|-------|-----|
| Anyways (Vimeo) | https://vimeo.com/206409021 |
| PIPS:lab Vimeo | https://vimeo.com/pipslab |
| Facebook | https://www.facebook.com/keez.duyves |
