...
7. **Pie menus in the pie-menu-history repo.** Live segment: build a Kando menu for this
   ...
   [Ben Shneiderman + Heinz Lemke pie menu history show](../../repo-shows/ben-and-heinz-pie-menus.yml):
   1969 PIXIE → CHI '88 → Kando, the whole lineage in one room.

## Sources (public)

- CHARACTER.yml · invitation.md · [show seed](../../repo-shows/simon-schneegans-pie-menus.yml)
