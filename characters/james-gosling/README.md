...
| **Sources** | [sources/2026-07-31-linkedin-retirement-thread.md](sources/2026-07-31-linkedin-retirement-thread.md) — the lander.ps comment thread · [sources/2024-07-05-reddit-retirement-thread.md](sources/2024-07-05-reddit-retirement-thread.md) — r/programming reception (Corretto, Greengrass, gosmacs love) · [sources/2020-04-12-hn-redisplay-algorithm.md](sources/2020-04-12-hn-redisplay-algorithm.md) — Don's HN redisplay walkthrough (skull & crossbones by Brian Reid) · [sources/EmacsRedisplayAlgorithm.pdf](sources/EmacsRedisplayAlgorithm.pdf) — the 1981 paper · [sources/ace-syntax-driven-preprocessor.md](sources/ace-syntax-driven-preprocessor.md) — Ace (1989): syntax-tree rewriting, `$tradeoff`/`$P`/`$trips` space-time specialization of the NeWS/Shapes inner loops ([the paper](sources/gosling89ace.pdf)) |
