# Don Hopkins ↔ Netochka Nezvanova — correspondence digest

Public-safe timeline. Full threads live in Don's private archive (`DonHopkins/characters/netochka-nezvanova/sources/`).
...
| ~2021 | **Twitter** | Don notes @antiorp active (Jacques Mattheij thread) |

## Don's standing invitation

Would love NN on a **Repo Show** — masked, text-only, or intermediary — any response including silence honored. Near-miss: **After Effects NATO host** (declined). Still reachable behind the mask (Don has had ongoing contact; details not published here).

↑ [Netochka Nezvanova](../README.md)
