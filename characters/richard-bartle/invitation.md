---
status: draft
character_id: richard-bartle
public: true
consent: not_yet_asked
show_seed: repo-shows/richard-bartle/
---

# Repo Show invitation — Richard Bartle

*Richard Bartle may edit, decline, delay, or request removal at any time — or take direct edit access. [Portrayal standards](https://github.com/SimHacker/WillWrightShowForFood/blob/main/schemas/portrayal-standards.md) — also covers quiet mode and onboarding.*
...
We would respectfully invite **Richard Bartle** to a **Repo Show** — a friendly recorded conversation whose stage is [this public GitHub repository](https://github.com/SimHacker/WillWrightShowForFood),
