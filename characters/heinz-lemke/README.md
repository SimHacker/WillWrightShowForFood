...
[Invitation](invitation.md) · [Correspondence](correspondence.yml) · [**Back to the Roots (Part 1, 1967)** — Heinz's own origin story](sources/1967-back-to-the-roots-part1.md) · [Source listing thread (7 Jul 2026)](sources/2026-07-07-pixie-trio-thread.md) · [PIXIE source recovery](pixie-source-recovery.md) · [Roy Eagleson — educator](../roy-eagleson/) · [Cambridge films → Bumblebee](cambridge-films-flight-of-the-bumblebee.md) · [**Yuja Wang — PIXIE tribute**](../yuja-wang/README.md) · [Pull-in gaps](pull-in-gaps.yml) · [Show seed](../../repo-shows/pixie-pie-menus-pdp7.yml) · Don's thread: [`../don-hopkins/pie-menus-chi-88-and-beyond.md`](../don-hopkins/pie-menus-chi-88-and-beyond.md)
