...
4. Fold the "not a dumb terminal" correction into the show's interview beats (done — see
   [the show seed](../../repo-shows/pixie-pie-menus-pdp7/README.md)).
...
↑ [Heinz's room](README.md) · [correspondence](correspondence.md) · [show seed](../../repo-shows/pixie-pie-menus-pdp7/README.md) · [pull-in gaps](pull-in-gaps.md)
