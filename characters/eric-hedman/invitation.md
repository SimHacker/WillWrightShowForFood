...
gold. I'd love a **Repo Show** (solo or Sims reunion) where we drive people to your channel and indie
work while digging into the craft.

**Threads — your pick:**

- **Vitaboy & hand-tuned animation** — walk cycles, idles, gestures; what gave Sims their soul.
- **The object pipeline** — stand-in Max renders → artist → animator → programmer, daily sandbox builds.
- **Expansion design stories** — mechanical bull, love bed, hot tub, and the rest of "my baby."
- **Drew Carey Show tie-in** — animating the in-game segment (pairs with a dream **Drew Carey** episode).
- **Pantomime Corporation** — reuniting with **David Levitt** and me; Sims animation meets AR/VR
  character work (natural three-hander or paired episode).
- **Then and now** — Disney/Henson/Nickelodeon → **Aether HeXXen** and indie VR/AR.
