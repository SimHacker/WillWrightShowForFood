# Invitation — Craig Hubley · Part 1 of 2

*[Portrayal standards](../../schemas/portrayal-standards.md) — edit, decline,
delay, or request removal anytime.*

This invitation comes in two parts, on purpose. Part 1 is a performance and an
instrument, with no explanation. Part 2 ([invitation-2.md](invitation-2.md)) is
the Rosetta Stone. **No peeking** — the whole point is what you see before
anyone tells you what you are looking at.

---

Craig!!!!!!!!!!! (all lefts reversed)

It's been too long since we talked!

I have an ambitious plan for world domination that I'd like to fill you in on.
...
SimCity Micropolis Tile Sets Space Inventory Cellular Automata to Jerry
Martin's "Chill Resolve"

https://www.youtube.com/watch?v=319i7slXcbI

Then go play with it yourself, still without explanation:
