# Suggested questions — Chris Trottier Repo Show 🪶

Seed list for audience voting and TicketPRs. Copy a question into your own audience subdirectory to vote and fork it.

## Design & legacy

**Looking back at your body of work, what is the one idea or prototype that you feel the industry still hasn't fully understood or adopted?**
...
- **Design by accretion in practice** — walk the Jan 2007 career map project by project; where did layers accrete?
- **Simlish invention day** — VOX sessions, consonant cards, actors enunciating nonsense into a language
- **TSO producer life** — Yoyo Mama, pinata-gate, in-game mafias, Will’s black-tie launch warning
- **Spore village idiot** — “If Chris can figure out the interface, anyone can”
- **Tuned emergence** — why gameplay didn’t come together until months before ship ([essay](tuned-emergence.md))
- **Sims team reunion** — with Will, Jamie, Claire, and the rest

## How to submit yours

1. Fork the repo (or browse in stealth mode if you don’t have an account yet)
2. Add your question under the show audience directory when it opens
3. Or email Don — we’ll transcribe with permission

---

↑ [Design by Accretion show](design-by-accretion.md) · [Chris Trottier](README.md)
