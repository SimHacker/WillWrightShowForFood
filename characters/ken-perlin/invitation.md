...
*Ken Perlin may edit, decline, delay, or request removal at any time — or take direct edit access. [Portrayal standards](https://github.com/SimHacker/WillWrightShowForFood/blob/main/schemas/portrayal-standards.md) — also covers quiet mode and onboarding.*
...
We would respectfully invite **Ken Perlin** to a **Repo Show** — a friendly recorded conversation whose stage is [this public GitHub repository](https://github.com/SimHacker/WillWrightShowForFood),
...
**Materials:** [`repo-shows/ken-perlin/`](https://github.com/SimHacker/WillWrightShowForFood/blob/main/repo-shows/ken-perlin/README.md)
