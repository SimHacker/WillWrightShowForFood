# The Documentarian's Tour 📺 — this repo, through Jess's eyes

*Written for Jess Bird — and for anyone who wants to see this repo the way a documentary
producer sees it: as **story arcs, interviewees, primary sources, and footage leads**, not code.*

No GitHub account needed. Every link below is a page you can read in a browser. No code literacy
required — the code is the *subject* here, the way a violin is the subject of a film about a
violinist.
...
For a documentarian, that means this repo is three things at once:

1. **A research archive** — sourced, dated, linkable primary material on The Sims / Maxis / Will Wright.
2. **A warm-contact roster** — people already engaged, portrayed with their consent process on record.
3. **A parallel production** — a code-first show you can point cameras at, quote, and draw from,
  which never competes with a broadcast documentary because it's a different animal entirely.

If you read nothing else, read the **evidence room** and the **people roster** below.
...
### Arc A: The dollhouse that almost wasn't
...
| [1998 Sims steering committee demo](../will-wright/sources/1998-06-04-sims-steering-committee-demo/)                        | Inside the room where the game fought for its life.                                                                                              |
| [1999 Sims alpha prototype](../will-wright/sources/1999-01-06-sims-alpha-prototype/)                                        | What it looked like a year before ship.                                                                                                          |
...
| Read                                                                                                                                                            | Why                                                                                                                      |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| [Sims 1 community landscape](../../catalogs/sims1-community-landscape.md)                                                                                       | The map — fan sites, tool makers, content creators, what survived and what rotted.                                       |
| [Heather Castillo / SimFreaks](../heather-castillo/README.md) · [Steve Alvey / SimSlice](../steve-alvey/README.md)                                                    | The community leaders Don already introduced you to — their rooms here carry the public story.                           |
| [Jeff Adkins / SimObliterator](../jeff-adkins/README.md)                                                                                                        | A fan who taught himself the save-file format and built preservation tools — **accepted guest**, actively collaborating. |
...
| **Heather & Steve Alvey** | [`heather-castillo/`](../heather-castillo/) · [`steve-alvey/`](../steve-alvey/)         | SimFreaks / SimSlice — community's institutional memory.                                                                                         |
...
| **Drew Carey**            | [`drew-carey/`](https://github.com/SimHacker/WillWrightShowForFood/tree/main/repo-shows/drew-carey/)                                                   | Dream guest — he's *in the Sims lore* (House Party, 2000) and a master of the live-audience form.                                                |
...
Producers need pictures. Public assets already in the repo:

- **[Will's media room](../will-wright/media/README.md)** — Maxis-era photos, Will's mixed-media
relief [artwork](../will-wright/media/artwork.md), programmer art, the Computer History Museum
Maxis display, SimFreaks catalog screenshots, the Drew Carey House Party crowd capture, and the
Transmogrifier Mona Lisa pushpins.
- **[Dumbold Voting Machine](../will-wright/media/sims-dumbold-voting-machine-README.md)** — Don's
Sims object with a full screenshot archive; a self-contained "objects had politics" segment.
- **[Video index](../will-wright/videos.yml)** — Don's YouTube demo archive (Transmogrifier,
...
You already have the short version from Don's email; the filed version is
[**Two documenting endeavours**](synergy/willwrightshowforfood.md). The core:

- **You document at broadcast scale.** Commissioning, rights, veteran access, the long patient cut.
- **Don ships code and interviews in public.** The repo is a living artifact your film can point
at — and its guests arrive already on record, already consenting, already sourced.
- **Neither waits on the other.** The repo show is not a rival documentary; it's the thing a
documentary about this world would want to *film happening*.

What to lift freely: primary sources, the community landscape, the consent-tracked roster.
What to ask Don for: introductions, scans, and interview footage as it accumulates.
...
*Reading order if you only have one cup of tea:* the [1996 talk](../will-wright/sources/1996-04-26-winograd-interfacing-to-microworlds/) →
[The Soul of The Sims](../will-wright/sources/2008-02-10-soul-of-the-sims/) →
[the Maxis people roster](../will-wright/media/sims-series-maxis-people.md) →
[the community landscape](../../catalogs/sims1-community-landscape.md) →
[the premiere tour](../../repo-shows/will-wright-premiere/BROWSE.md).

↑ [Jess's room](README.md) · [characters](../README.md) · [repo front door](../../README.md) · [entryways](../../ENTRYWAYS.md)