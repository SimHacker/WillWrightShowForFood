...
cut, Don is building the show's world in public: every guest gets a room
([`characters/`](../README.md)), every episode idea gets a seed
...
[`characters/INDEX.yml`](../INDEX.yml); the human version:
...
[`synergy/willwrightshowforfood.yml`](synergy/willwrightshowforfood.yml). The core:
