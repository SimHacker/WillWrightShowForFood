...
| [SimCity → free: the OLPC email thread](../will-wright/sources/2006-11-13-simcity-olpc-email-thread/)                   | The receipts, 140 days after Long Now: John Gilmore's email relays the charge — channeling the two askers' spark and the lightning bolts Don had written years before — then Will's yes, EA's clearance, and SimCity running on the XO-1 children's laptop by New Year's. Verbatim emails plus photos. Narrative cut: [the open-source saga](../will-wright/sources/simcity-open-source-saga/). |
