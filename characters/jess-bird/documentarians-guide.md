...
| [Heather Alvey / SimFreaks](../heather-alvey/README.md) · [Steve Alvey / SimSlice](../steve-alvey/README.md)                                                    | The community leaders Don already introduced you to — their rooms here carry the public story.                           |
...
| [SimCity → free: the OLPC email thread](../will-wright/sources/2006-11-13-simcity-olpc-email-thread/)                   | The receipts, 140 days after Long Now: John Gilmore connects the OLPC project to the charge — the two askers' spark plus the lightning bolts Don had written years before — then Will's yes, EA's clearance, and SimCity running on the XO-1 children's laptop by New Year's. The heavy lifting belongs to **Walter Bender**: Stone Soup, the OLPC GDC booth (which Don manned) recruiting developers to the cause. Verbatim emails plus photos. Narrative cut: [the open-source saga](../will-wright/sources/simcity-open-source-saga/). |
