...
- **Jess → repo:** broadcast credibility, veteran access, research depth
- **Repo → Jess:** working demos, published primary sources, community guests already warmed

## Independence

Neither project waits on the other's green light — each ships on its own clock.

---

↑ [Jess's room](../README.md) · *Machine-readable:* [`willwrightshowforfood.yml`](willwrightshowforfood.yml)
