...
# Repo Show invitation — Bruce "Tog" Tognazzini

*Send-ready draft — not yet sent. Bruce Tognazzini may edit, decline, delay, or request removal at any time.*
...
the 1987 edition *justified* its decisions on the page (submenu delays, forgiveness zones)
in a way modern guidelines never do. [1987 edition on archive.org](https://archive.org/details/applehumaninterf00appl)
- **The "<" buffer, walked end to end** — you invented it, Jim Batson did the math, Frank
Leahy shipped it (I worked with Frank at Current TV — he was touched anyone noticed), NeXT
...
**Your response:** yes, later, too busy, or no — all honored gracefully. (And whatever you
answer, the site rescue offer stands independently — that one's overdue.)

— Don Hopkins *(the User Interface Flower Child)* 🥧🎩

`🎩 Apple HIG` · `📐 the "<" buffer` · `🎯 Fitts quiz rematch` · `🐒 infinite monkeys, answered` · `🚑 AskTog rescue`
