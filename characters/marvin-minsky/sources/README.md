# Marvin Minsky — sources

| File | What |
|------|------|
| [`papers/`](papers/README.md) | Primary-source PDFs: AIM-33 (7×4 UTM), Steps (1961), Matter Mind & Models (AIM-77), Frames (AIM-306), Plain Talk (AIM-430), K-Lines (AIM-516, with OCR text), Jokes (AIM-603), Music Mind & Meaning (AIM-616) |
...
The living skill + examples that use this paper:

| | |
|--|--|
| **Paper (markdown)** | https://github.com/SimHacker/moollm/blob/main/skills/no-ai-joking/MINSKY-JOKES.md |
| **Skill** | https://github.com/SimHacker/moollm/tree/main/skills/no-ai-joking |
| **Examples** (spinach/mayo, circular exchange, quine, ultimate machine, cognitive bugs) | https://github.com/SimHacker/moollm/tree/main/skills/no-ai-joking/examples |
