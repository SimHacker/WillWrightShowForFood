...
## 1 · Don Hopkins <dhopkins@donhopkins.com>
        ...
        **Date:** 24 August 2006 at 15:34:55 GMT+2  
        **Subject:** [Laszlo-dev] Laszlo for Lua? "OpenLuaszlo"  
        **To:** OpenLaszlo development and bug reporting <laszlo-dev@openlaszlo.org>, Don Hopkins <dhopkins@donhopkins.com>
...
## 2 · Jim Grandy <jgrandy@openlaszlo.org>

        **Date:** 24 August 2006 at 18:43:52 GMT+2  
        **Subject:** Re: [Laszlo-dev] Laszlo for Lua? "OpenLuaszlo"  
        **To:** Don Hopkins <dhopkins@donhopkins.com>

        On Aug 24, 2006, at 6:34 AM, Don Hopkins wrote:
...
Without leaving the JavaScript language family too far behind, there's another option, Nicolas Cannasse's haXe programming language. It's basically JavaScript-meets-strong-typing, and the haXe compiler (written in OCAML) targets Flash 6, 7, 8, *and* 9, plus DHTML and Nicolas' own VM, neko.

http://haxe.org

haXe is being used for Flash and HTML development, plus the combination of haXe and neko are being used on the server side. Finally, there's active work on a native client runtime called Screenweaver HX, kind of an odd beast that uses neko for client API access and flash for display, with flash remoting communicating between the two:

http://haxe.org/swhx

Neko doesn't yet have SWIG integration, but members of the community have done some work one that while building OpenGL bindings.
