...
![Will Wright artwork — full multi-panel evolution / systems construction with symbol tags](will-artwork-evolution-full.png)

The whole piece.

![Detail — a fitness-landscape curve with an orange arrow, yellow nodes, and mountain / DNA tags](will-artwork-evolution-detail-fitness.png)

Detail: a **fitness-landscape**–style curve with an orange arrow climbing it, tagged with a
mountain and a DNA-helix icon.

![Detail — central node cluster tagged with a sex symbol and a dice symbol (variation / recombination)](will-artwork-evolution-detail-genetics.png)

Detail: a central cluster of pins crossed by red links, flanked by a **♂/♀** sex symbol and a
**dice** symbol — recombination and chance.

![Detail — symmetric branching panel tagged with a phylogenetic-tree icon](will-artwork-evolution-detail-branching.png)

Detail: a symmetric, layered panel under a **branching-tree** (phylogeny) icon, studded with
blue/yellow/green pins.

![Detail — stacked contour "shelves" connected by rods (stratified layers / generations)](will-artwork-evolution-detail-terraces.png)
...
![Will Wright artwork — green cells dividing toward a central hub, with mitosis sequence along the bottom](will-artwork-cell-division.png)
...
![Will Wright artwork — blue-and-brown contour relief of a bay / coastline (San Francisco Bay-like)](will-artwork-bay-area-relief.png)
...
![Will Wright artwork — green contour relief of a hillside neighborhood with winding roads and blue houses](will-artwork-neighborhood-relief.png)

A green contour relief of a **hillside neighborhood**: winding roads with rows of blue houses
and one pink house picked out.

![Will Wright artwork — relief of a building / floor plan with rooms wrapped around a teal pool](will-artwork-floorplan-relief.png)
