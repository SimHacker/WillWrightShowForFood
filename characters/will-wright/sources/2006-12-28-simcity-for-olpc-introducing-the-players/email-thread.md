...
Thanks! Walter Bender \<[email redacted]\>, OLPC President, Software and Content, responded today from Dubai to Mitch's copy of my message, and he'd be very happy to see SimCity ship on the OLPC:
...
**Chuck Normann** \<[email redacted]\> is the point man for Electronic Arts, which owns the SimCity code (it bought Maxis many years ago). He's poking around in the EA bureacracy to find out how easy or hard it will be to relicense the code under the GNU General Public License.

**Doreen Nelson** \<[email redacted]\>, Professor of Education at Cal Poly Pomona, wrote the SimCity curriculum guides for Maxis, which we hope can be freed up along with the software. The NY Times called her "one of the thirty most innovative educators in the USA."
