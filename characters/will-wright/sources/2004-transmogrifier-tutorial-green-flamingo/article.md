...
| 4 | **Clone Object File** — unique filename (e.g. `flamingo813554`), optional **Magic Cookie** (16-bit producer ID from [registry](../2004-transmogrifier-magic-cookie-registry/README.md)) |
...
No slots, sounds, walls, floors, character skins, SimAntics behaviors, etc. — see [Glossary](../2004-transmogrifier-glossary/README.md) and main docs on Wayback.
