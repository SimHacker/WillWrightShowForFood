...
centerpiece by design (see [SHOW.yml · topic-less-by-design](../../../../repo-shows/will-wright-premiere/README.md#topic-less-by-design)).
...
backward post-mortem, same two people in the room. (See [SHOW.yml · the-arc](../../../../repo-shows/will-wright-premiere/README.md#the-arc).)
...
**Earlier published stratum:** [2004 Winograd essay](../2004-01-12-winograd-ui-simulation-games/README.md) — pre-Medium, no figures; compare to see how the write-up evolved. **Missing earliest stratum:** raw `.txt` notes from ~1996 (emailed to Will for review) — see that README TODO.
...
| Open-source saga | [simcity-open-source-saga](../simcity-open-source-saga/README.md) |
| Terry Winograd | [terry-winograd](../../../terry-winograd/README.md) · [CS547 archive](../../../terry-winograd/media/cs547-ARCHIVE.md) |
