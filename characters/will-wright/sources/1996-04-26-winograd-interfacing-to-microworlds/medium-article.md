...
*Full text capture from Medium. All 167 article images downloaded locally — see [`README.md#image-gallery`](README.md#image-gallery) (files in `images/`, caption map in `images/map.tsv`). Embedded YouTube links collected in [`videos.md`](videos.md).*
...
> 📸 **Illustrated version:** every figure from the article is mirrored locally — [`README.md#image-gallery`](README.md#image-gallery).
