# Videos linked from the 1996 Winograd / Will Wright Medium article

Embedded YouTube videos (and the Google-Drive PDF embed) extracted from the article, in order:

1. **Will Wright — Maxis — Interfacing to Microworlds — 1996-04-26** (the talk itself)
   <https://www.youtube.com/watch?v=nsxoZXaYJSk>
   Archive: <https://searchworks.stanford.edu/view/yj113jt5999>
2. **Introduction to Block Programming with Snap!**
   <https://www.youtube.com/watch?v=3Adr7e0UIcE>
...
7. **The Sims Steering Committee — June 4 1998**
