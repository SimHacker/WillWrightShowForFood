...
**[article.md](article.md)** — timeline + Don's Dec 2006 pitch letter (SimCityNet UI excerpt). Read
this first, then branch to threads below.
...
- [Walter Bender OLPC show](../../../../repo-shows/walter-bender-olpc/README.md)
...
- MicropolisCore `documentation/designs/` — Willmott correspondence, Guru doc
...
↑ [sources](../README.md) · [license chain](../maxis-licenses-chain-of-custody/README.md) · [1996](../1996-04-26-winograd-interfacing-to-microworlds/README.md) · [`GLANCE.yml`](GLANCE.yml)
