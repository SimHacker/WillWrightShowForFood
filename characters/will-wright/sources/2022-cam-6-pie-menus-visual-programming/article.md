...
## CAM-6 and Henry Minsky

Don notes **Henry Minsky** (Marvin's son) — cellular automata community overlap with Fredkin, Margolus, Toffoli at MIT. Don's high-school ARPANET access to MIT-AI Lab led to Emacs, Lisp, and later HCI work with Ben Shneiderman.

**CAM-6 demos on YouTube:**

- https://www.youtube.com/watch?v=TrScy1icWjI
- https://www.youtube.com/watch?v=edXRNtuAGTg (alternate)

Taxonomy reference Don cites: [Simulation software taxonomy (Kurt Schmucker, Apple, 1999)](http://donhopkins.com/home/documents/taxonomy.pdf)

---

## PSIBER Space Deck (NeWS, 1989)

Visual debugger/editor for PostScript in the NeWS window system — pie menus, live object inspection:

- Medium: [The Shape of PSIBER Space](https://medium.com/@donhopkins/the-shape-of-psiber-space-october-1989-19e2dfa4d91e)
- Ties to [OLPC PSIBER article](../2007-11-16-olpc-visual-programming-psiber/README.md)
...
After Interval → Maxis with Will Wright:

| Demo | URL |
|------|-----|
| Edith + pie menus + SimAntics | https://www.youtube.com/watch?v=-exdu4ETscs |
| Steering committee Jun 1998 | https://www.youtube.com/watch?v=zC52jE60KjY |

Community wikis: [Mod The Sims SimAntics](https://modthesims.info/wiki.php?title=SimAntics) · [simantics.wikidot.com](http://simantics.wikidot.com/)

Paper: [Programming Objects in The Sims (QRG Northwestern)](http://www.qrg.northwestern.edu/papers/Files/Programming_Objects_in_The_Sims.pdf)

WWSFF: [don-youtube-exdu4ETscs-edith-simantics-demo](../don-youtube-exdu4ETscs-edith-simantics-demo/README.md)

---

## Scott Kim *Viewpoint* (1988)

Don's defense of visual-first programming — Scott's PhD demo (Knuth advisor, Xerox PARC Cedar/Dorado):

- https://www.youtube.com/watch?v=9G0r7jL3xl8
- Thesis: [Viewpoint dissertation PDF](http://www.scottkim.com.previewc40.carrierzone.com/viewpoint/viewpoint-dissertation.pdf)

Thesis claim: *"Only by treating the screen itself as a first class citizen will we be able to build computers that are truly for visual thinkers."*
