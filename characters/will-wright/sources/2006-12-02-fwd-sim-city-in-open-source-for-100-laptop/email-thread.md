...
## 2 · Don Hopkins <dhopkins@DonHopkins.com>

        **Date:** 2 December 2006 at 09:58:36 GMT+1  
        **Subject:** Re: [Fwd: Sim City in open source for $100 Laptop?]  
        **To:** Will Wright <willdude@gmail.com>

        I think this Eric Scharff dude might be interested in an open source scriptable version of SimCity (and SimEarth). 
He even wrote about what could be done if the source code to SimCity were available, in his PhD thesis on "Open Source: A Conceptual Framework for Collaborative Artifact and Knowledge Construction"! 
Do you know him? Think he'd he be interested in helping out? 

    -Don

http://www.isse.ucar.edu/scharff/

Welcome! I am a Project Scientist with the Institute for the Study of Society and Environment (ISSE) of the National Center for Atmospheric Research (NCAR). I am currently working on the Disaster Dynamics project. We are creating educational games for understanding natural disaster planning. Before coming to NCAR, I was a member of the Center for LifeLong Learning and Design at the University of Colorado at Boulder. I received my Ph.D. in Computer Science studying the collaborative construction aspects of Open Source Software. You can read my thesis if you are interested. I received my undergraduate degree from Cornell University where I studied Computer Science and Psychology.

http://www.isse.ucar.edu/scharff/thesis/

Open Source: A Conceptual Framework for Collaborative Artifact and Knowledge Construction
by Eric David Scharff
B.A., Cornell University, 1996
M.S., University of Colorado, 2000
A thesis submitted to the Faculty of the Graduate School of the University of Colorado in partial fulfillment of the requirements for the degree of Doctor of Philosophy, Department of Computer Science, 2002.

http://www.isse.ucar.edu/scharff/thesis/chap3.pdf

3.4 Open Source and Open Systems

Open source software is a subset of a larger class of computer systems, open systems. From a technological perspective, an open system is one in which making extensions is a central aspect of system use. More generally, open systems are those that provide facility for modification not just at the time when a system is designed, but at any time in a system's life.

Perhaps the easiest way to understand open systems is through contrast with closed systems.  In a closed system, there is a clear separation between the activities of designing a system and using a system. At the time in which the system is designed, the space of uses is explicitly created by the system designers. At some later time, users interact with a system, but if the system is closed their interaction is fundamentally constrained by the decisions made at design time. A concrete example is SimCity [Web 15], a popular city simulation game. The designers of SimCity anticipated a certain set of uses for the system, and these constraints became a fundamental part of the system design.  Players have the ability to change some aspects of their city (such as building roads, deciding land zoning, and setting taxes) but not others. For example, traffic in a simulation is derived from models that can not be changed by users. One can only reduce traffic by adding roads or introducing mass transit. There is no capability for exploring different models for reducing traffic, such as introducing gasoline taxes or encouraging telecommuting (because these changes are not possible within the system). SimCity is a partially open system because it allows some changes, and partially closed because other options are not available to the end users.

Open systems is really a continuum based on the kinds of changes that are possible within a program. On one extreme, a car's computer controlled fuel injection may be extremely closed, as users have virtually no direct way to change the software or how it behaves in different circumstances.  In theory, open source systems fall at the other extreme because they are "totally open." If the source code to SimCity were available, one could potentially add the changes described above.  Anyone with sufficient time, motivation, or aptitude could change how the system responds. In practice, many changes are impractical even if total control is available. Changing a SimCity-like simulation to work as a relational database is probably not a productive or particularly easy activity.  Open systems and open source are related concepts. Studying open source can show how some communities produce types of open systems. Studying open systems (both from a technical and theoretical standpoint) can highlight the design challenges in systems that grow through extension. Open systems differ from open source in both the object produced and the collaborative technology employed. Nevertheless, lessons from open systems can influence open source collaborative construction, and vice versa.
