...
*Source: [http://www.art.net/~hopkins/Don/simcity/manual/inside.html](http://www.art.net/~hopkins/Don/simcity/manual/inside.html)*  
...
Birthrate as used here, is actually a combination of the birthrate (positive) and the deathrate (negative). Within SimCity there is always a positive birthrate. 
