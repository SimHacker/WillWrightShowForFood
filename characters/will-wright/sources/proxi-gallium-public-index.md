...
| 2025-12 | [will-wright-dev-diaries](2025-12-will-wright-dev-diaries/README.md) | YouTube — heirloom, Minecraft export, Bartle, pronoun surfing |
...
4. **Dev Diaries 2025** — shipped Minecraft bridge + software heirloom on camera.

## Cross-cutting quotes

| Quote | Sources |
|-------|---------|
| Narcissism of players | T1D stream, Reddit AMA, PC Gamer |
| Smart objects advertise | Reddit AMA, VentureBeat |
| Not AI simulating emotions — mapping connections | Reddit AMA |
| 24 → 100 memories fascinating | VentureBeat |
| Grandmother shared world | Reddit AMA, Dev Diaries heirloom |
