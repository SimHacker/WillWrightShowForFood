...
![SimCopter himbo crowd at night — orange male figures on dark ground, lit buildings behind](simcopter-himbos-crowd-night.png)

Close-ups — bright points on the chest at sprite scale:

![SimCopter himbo close-up 1 — single figure, bright chest points](simcopter-himbo-closeup-1.png)

![SimCopter himbo close-up 2 — two figures walking](simcopter-himbo-closeup-2.png)

![SimCopter himbo close-up 3 — figure with visible face](simcopter-himbo-closeup-3.png)
...
![SimCopter helicopter view — bright points scattered across the dark city at distance](simcopter-city-glow-distance.png)
