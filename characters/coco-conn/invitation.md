---
status: invited  # sent 2026-07-06 via Facebook
...
mixing console** you **performed with your hands**, and out of that shop came ***Atomic Dog***, ***Abracadabra***,
**RoboCop**, **Total Recall**, and ***Flying Logos*** sneaking into **SIGGRAPH '89** when demos were
banned.

I'd love you on a **Repo Show** — live, friendly, whole stage a public GitHub repo people can clone and
build on.

What I'd love to hear, your pick:

- **Charles Moore at Sunset Gower** — hiring **Forth, Inc.**; **PolyForth** in **32K**; **24 Z80**
  channels; learning **Forth** from the inventor while shipping **music videos**. You said you learned
  **OOP without knowing it** — I'd love that story in your voice.
- **Homer II as instrument** — touch **faders**, **joystick bumper** through the **score**, **hero
  floppy** to the **optical printer**, **ten passes** to one frame. Performance UI before anyone called
  it that.
- **Flying Logos** — Peter turning the **demo reel** into a **film** to beat the SIGGRAPH committee;
  **Niccograph of Japan**; my **Flying Logo Heaven** fanfic where the **Sun** and **SGI** logos still
  dance. (Still want that screensaver.)
- **SIGKids → CitySpace** — the kids-off-the-floor ethos, collaborative worlds, and whatever you want
