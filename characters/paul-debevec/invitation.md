---
status: draft
character_id: paul-debevec
public: true
consent: not_yet_asked
show_seed: repo-shows/paul-debevec/
---

# Repo Show invitation — Paul Debevec

*Paul Debevec may edit, decline, delay, or request removal at any time — or take direct edit access. [Portrayal standards](https://github.com/SimHacker/WillWrightShowForFood/blob/main/schemas/portrayal-standards.md) — also covers quiet mode and onboarding.*
...
We would respectfully invite **Paul Debevec** to a **Repo Show** — a friendly recorded conversation whose stage is [this public repository](https://github.com/SimHacker/WillWrightShowForFood),
