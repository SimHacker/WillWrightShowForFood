...
# Repo Show invitation — Brian Silverman

*Brian may edit, decline, delay, or request removal anytime.*
[Portrayal standards](https://github.com/SimHacker/WillWrightShowForFood/blob/main/schemas/portrayal-standards.md)

Brian —

**Will Wright Show For Food** is a long-form interview series about **microworlds** — SimCity,
Logo, cellular automata, pie menus, emulators, constructionist tools — where the evidence lives in
a public GitHub repo and the audience can fork it, run it, and correct us. **Will Wright is in**
...
[willing contributions](https://github.com/SimHacker/WillWrightShowForFood/blob/main/process/guest-participation-ladder.md)
if you want them.
