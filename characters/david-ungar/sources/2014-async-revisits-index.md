# 2014 async revisits — Lang.NEXT treasure hunt

Don Hopkins's Aug 2026 pitch to David Ungar: **re-listen, write notes, David replies on his
schedule, Don drafts deep articles** — no new video required. TicketPR-shaped written participation.

Both talks are **Lang.NEXT 2014**. Same conference, two under-appreciated episodes.
...
**Correspondence:** [`2026-08-correspondence-facetime-and-async-pitch.md`](2026-08-correspondence-facetime-and-async-pitch.md)  
**Invitation:** [`invitation.md` Option D](../invitation.md)  
**Format policy:** [repo-show-format.md — TicketPR](../../../process/repo-show-format.md#ticketpr)
