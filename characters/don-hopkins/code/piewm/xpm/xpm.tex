...
\vspace{2cm}
\begin{center} 
\Large Version \RCSRevVersion$Version: 3.2a $\\
\end{center}
\vspace{2cm}
\begin{center}
...
{\bf XpmReturnExtensions}, {\bf XpmReturnInfos}, and sets the {\bf XpmSize}
and possibly the {\bf XpmHotspot} attributes when returning .
