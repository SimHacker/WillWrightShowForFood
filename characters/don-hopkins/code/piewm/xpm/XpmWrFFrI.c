...
LFUNC(WriteTransparentColor, int, (FILE *file, char **colors, unsigned int cpp,
				   unsigned int mask_pixel,
				   char ***colorTable));

LFUNC(WriteOtherColors, int, (FILE *file, char **colors, XColor *xcolors,
...
LFUNC(WriteExtensions, int, (FILE *file, XpmExtension *ext, unsigned int num));

#ifdef NEED_STRDUP
LFUNC(strdup, char *, (char *s1));
