...
: :case
  create ] does> swap /token * + @ execute ;
...
10 constant menus/cell

: asd ( n --- n+5 )
  dup , menus/cell + ;

create cell-offsets 0 asd asd asd asd asd asd drop
...
: announce-menu
  ...
  home cleos
  cr 27 spaces ." Choose '"
  2dup menu-line-name type ." '." cr cr
  <log
     ." Choose " show-line-number-name cr
  log>
;
...
: (do-record
  ...
  <log
    ." Time: " .ms 
    3 spaces ." Selected: "
    this-menu @ over show-line-number-name cr
  log>
  8 spaces ." Selected: "
  this-menu @ over menu-line-name type cleos 13 emit
