#ifndef lint
static char *rcsid_globals_c = "$Header: globals.c,v 10.3 86/02/01 16:24:12 tony Rel $";
#endif	lint
...
Cursor PieCursor;		/* Pie cursor. */
Cursor SliceCursor;		/* Pie cursor. */
...
int MenuRadius;			/* Radius of items from menu center. -DEH */
...
Bool PieMenus;			/* Use pie menus? -DEH */
...
Keyword KeywordTable[] = {
    ...
    { "f.focus",	IsQuitFunction,	0,0,0,Focus },
    { "f.forth",	IsQuitFunction, 0,0,0,Forth },
    { "f.iconify",	IsQuitFunction,	0,0,0,Iconify },
    { "f.lower",	IsQuitFunction,	0,0,0,Lower },
    ...
    { "menu",		IsMenu,		&PieMenus,0,0,0 },
    { "menufont",	IsString,	0,0,MFontName,0 },
    { "menuradius",	IsNumeric,	0,&MenuRadius,0,0 },
    ...
    { "pulldownmenu",	IsMenu,		&FalseFlag,0,0,0 },
    { "pulldownmenus",	IsBoolFalse,	&PieMenus,0,0,0 },
    ...
    { "piemenu",	IsMenu,		&TrueFlag,0,0,0 },
    { "piemenus",	IsBoolTrue,	&PieMenus,0,0,0 },
