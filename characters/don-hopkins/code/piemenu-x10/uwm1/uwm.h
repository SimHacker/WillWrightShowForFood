...
#define DEF_MENU_RADIUS		80 /* -DEH */
#define DEF_PIE_MENUS		FALSE /* -DEH */
#define DEF_VOLUME		4
...
typedef struct _menuinfo {
    ...
    int name_x;			/* Name x position. -DEH */
    int name_y;			/* Name y position. -DEH */
    Window w;			/* Menu window. */
    Bool piemenu;		/* True for pie menus. -DEH */
    int items;			/* Number of menu items. -DEH */
    int initial_x;		/* X pos of initial selection. */
    int initial_y;		/* Y pos of initial selection. */
    int radius;			/* Radius of items from menu center. -DEH */
    int center_x;		/* Menu center x. -DEH */
    int center_y;		/* Menu center y. -DEH */
...
typedef struct _menuline {
    ...
    int width;			/* Width of the item name in pixels. */
    int type;			/* IsShellCommand, IsForthCommand, IsText, IsTextNL... */
    int x_offset;		/* Name x offset from center. */
    int y_offset;		/* Name y offset from center. */
...
extern Cursor PieCursor;	/* Pie cursor. */
extern Cursor SliceCursor;	/* Pie cursor. */
...
extern int MenuRadius;		/* Radius of items from menu center. -DEH */
...
extern Bool PieMenus;		/* Use pie menus? */
