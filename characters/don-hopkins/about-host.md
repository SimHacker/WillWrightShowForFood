...
Factual, playful, linkable. Not a job hunt — a **portfolio** and Repo Show stage.

**One line:** User Interface Flower Child — pie menus, The Sims tools, open-source Micropolis, MOOLLM microworld OS, Repo Show Class host.
...
- **Repo Show / Repo Show Class** — design in public; GitHub as MMORPG; show don't tell ([`repo-show-host-facet.md`](repo-show-host-facet.md))
