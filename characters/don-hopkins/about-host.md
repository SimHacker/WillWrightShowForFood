# About the host — resume reimagined as a repo room

Factual, playful, linkable. A **portfolio** and Repo Show stage — and yes, also a
job hunt: I'm **available for hire (2026)** — see [`hire-me.md`](hire-me.md).

**One line:** User Interface Flower Child — pie menus, The Sims tools, open-source Micropolis, MOOLLM microworld OS, Repo Show host.
...
- **Repo Show** — design in public; GitHub as MMORPG; show don't tell ([`repo-show-host-facet.md`](repo-show-host-facet.md))

## Where the depth lives

| Axis | File |
|------|------|
| Ideas bundle → MOOLLM | [`career/lineage.yml`](career/lineage.yml) |
| Stack range 6502 → LLM | [`career/range.yml`](career/range.yml) |
