👤 **Don Hopkins** — User Interface Flower Child: pie menus, The Sims tools, open-source **Micropolis**, **Repo Show** host, **MOOLLM** microworld OS.
...
*Self-sovereign host portrayal — Don represents himself. Adventure-game layer lives upstream in [MOOLLM adventure-4](https://github.com/SimHacker/moollm/tree/main/examples/adventure-4/characters/real-people/don-hopkins).*
