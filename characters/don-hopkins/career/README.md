...
Structured public record of Don's work history and project threads — the substrate the host's bio,
trails, and show pitches draw on.

- [`INDEX.yml`](INDEX.yml) — index of this directory.
- [`work-history.yml`](work-history.yml) — roles and timeline.
- [`project-threads.yml`](project-threads.yml) — recurring project threads across the years.
