# The Sims — Transmogrifier, RugOMatic, SimShow

**Maxis / EA (1997–2007):** core team — pie menu UI, **VitaBoy** animation pipeline, architectural editing advocacy, and the **mod tools** that seeded the community.

## Tools Don shipped or pushed

| Tool | Role |
|------|------|
| **Transmogrifier** | Object authoring — EA click-through distribution |
| **RugOMatic** | Custom floor coverings |
| **SimShow** | Presentation / demo layer |
| **Pie menus** | Gestural tool selection across the game |

## Themes

- **Objects carry behavior** — SimAntics / Edith advocacy (inspectable microworlds)
- **Same-sex romance** — inclusivity thread (see Will Wright sources; handle with care if quoting)

## Primary sources (Will Wright evidence room)
