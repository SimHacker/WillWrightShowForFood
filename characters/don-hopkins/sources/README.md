...
| Read | Girder | What |
|------|--------|------|
| [LLogo — MacLISP on ITS](llogo-maclisp-its.md) | [llogo-maclisp-its.yml](llogo-maclisp-its.yml) | ~12,480-line rescue — [full source](llogo-maclisp-its/llogo.lisp.txt) in repo |
| [Logo Adventure — C64 Terrapin](logo-adventure-c64-terrapin.md) | [logo-adventure-c64-terrapin.yml](logo-adventure-c64-terrapin.yml) | First commercial sale; REPL-as-parser |
| [Logo archaeology — HN digest](logo-archaeology-hn-digest.md) | — | Thread index 2016–2026 |
| [Bounce dataflow control flow](bounce-dataflow-control-flow.md) | [bounce-dataflow-control-flow.yml](bounce-dataflow-control-flow.yml) | Switch, enable, while — answers Brian's CPS hang-up |
| [Micropolis × Svelte runes × Snap! bridge](micropolis-svelte-snap-constraint-bridge.md) | [micropolis-svelte-snap-constraint-bridge.yml](micropolis-svelte-snap-constraint-bridge.yml) | Garnet/OL constraints → `MicropolisReactive.svelte.ts` → Snap! blocks |
...
**Crazy Idea Jam:** [Voystick](../../../process/crazy-idea-jam.yml#voystick-homomorphic-vocal-joystick) · [Urban Safari](../../../process/crazy-idea-jam.yml#urban-safari-gps-storytelling) · [eBike Safari](../../../process/crazy-idea-jam.yml#ebike-safari)
...
| [1989-05-25-hubley-chi90-interactive-performers-cfp/](1989-05-25-hubley-chi90-interactive-performers-cfp/README.md) | **CHI'90 Empowered archive** — CFP, mail, production, director's notes, **Shneiderman photo**, Medium 2018 |
...
↑ [Don's room](../README.md) · [Brian's CSLS](../../brian-harvey/sources/computer-science-logo-style.md) · [Palmhoo history](../../../palmhoo/history-and-lore/logo-llogo-and-c64-adventure.md)
