...
- **The OWM design doc, in public.** "OWM is the 'Open Window Manager' we
  ...
  **indexing tabs, pie menus, rooms, and a scrolling virtual desktop**.
  ...
  archived in [Josh Siegel's room](../../josh-siegel/sources/owm.ps).
...
↑ [Sources index](README.md) · [owm.ps source](../../josh-siegel/sources/owm.ps) · [Josh Siegel's room](../../josh-siegel/README.md) · [1991 ICCCM death match](1991-09-news-tnt-icccm-death-match.md) · [Don's room](../README.md)
