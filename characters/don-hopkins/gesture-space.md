...
| Show seed | Hook |
|-----------|------|
| [`../../repo-shows/gesture-space-self-revealing-ui.yml`](../../repo-shows/gesture-space-self-revealing-ui.yml) | Gesture space + pie menus vs graffiti; Norman/Jobs receipts; live constraint tracker |
