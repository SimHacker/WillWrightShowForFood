# First Person Poopers — A Field Guide to the Genre (HN, Aug 2026)

**A taxonomy of games where defecation is the core verb, every link and quote verified against the primary source.**

Born in the thread about the SF-as-a-video-game demo, as the answer to "What's the
actual game? Try not to step in doo-doo?" The joke escalates from one gag quote
into a documented genre survey: "First Person Pooper" is not a Steam category but
a recurring critics' coinage (Rock Paper Shotgun used it as a literal headline,
Eurogamer coined "first-person pooper-scoop-'em-up"), and the specimens span
every possible relationship between player and poop — producing it, scooping it,
weaponizing it, withholding it, and in the NS2: Combat case, becoming it.
...
[49431612](https://news.ycombinator.com/item?id=49431612) (the FPP comment,
replying to wyclif's "Where's the human poop on the sidewalks?").
...
https://www.youtube.com/watch?v=WacIMCEhVYU
...
| Branch | Core verb | Specimens |
|--------|-----------|-----------|
| Active pooper | Deliberately produce and deploy | Sploot, A Dump in the Dark, Bird Game |
| Poop management | Collect and clean | Zoo Tycoon 2, Pooper Scooper (iOS 2009) |
| Poop as strategy | Hide/contest poop as game objects | Pooper Scooper (Steam, dog vs. human) |
| Poop avoidance | Hold it in | Party Pooper |
| Poop as catharsis | Weaponized throwing | Poop On 2020 Simulator |
| Poop becoming | Undergo the digestive pipeline | NS2: Combat |
| Abstract deposition | Movement whose persistent trace is excretion | Reverse Pac-Man |

Reverse Pac-Man may be the Platonic FPP: ordinary Pac-Man consumes dots;
reverse Pac-Man traverses the maze depositing them — the exact inverse of
Pac-Man's digestive function. Not another poop joke but a game-mechanics
inversion, which is what elevates the whole list.

## Receipts (all verified 2026-08-25)

Every link curl-checked, every quote grepped verbatim from the page source.

| Claim | Verified |
|-------|----------|
| RPS headline "First-Person Pooper: Swallowed Alive In NS2 Combat" | Verbatim `<title>` of [the article](https://www.rockpapershotgun.com/natural-selection-2-combat-devour-guts) |
| "finale of the digestion process. All from an appalling first-person view. What great guts!" | Verbatim in article body |
| Thomas Loupe quote ("horrified at the idea of being eaten alive…") | Verbatim, attributed "director and sound designer Thomas Loupe told me" |
| YouTube link | Official "Faultline Games - NS2:Combat Devour Teaser" |
| Eurogamer "world's first first-person pooper-scoop-'em-up" | Verbatim in [Zoo Tycoon 2 review](https://www.eurogamer.net/r-zootycoon2-pc): "The fact it turns the game into the world's first first-person pooper-scoop-'em-up is just an added bonus." |
| Boing Boing Sploot headline | Verbatim title "Poop on everyone as a beautiful seagull"; live page 403s curl but loads in browsers; [Wayback snapshot](https://web.archive.org/web/20250826121234/https://boingboing.net/2015/08/24/sploot-seagull-poop-game.html) |
| A Dump in the Dark ammo classes | Cannon Shot, Liquid Diarrhea, Rapid Fire, Sniper Shot — all on the [Steam page](https://store.steampowered.com/app/577080/A_Dump_in_the_Dark/) |
| Pooper Scooper (Steam) dog-vs-human description | Verbatim from [Steam page](https://store.steampowered.com/app/682370/Pooper_Scooper/) |
| Pooper Scooper (iOS 2009, Infinaut Technologies) | App Store page dead (404); [Wayback snapshot](https://web.archive.org/web/20250812150108/https://apps.apple.com/us/app/pooper-scooper/id320696112); "Zookeeper Zeke", "No time to dally - there is poop to scoop!", "BECOME THE POOPER SCOOPER!!!" from the store description |
| Zeke / Taito Zoo Keeper (1982) | Taito's arcade Zoo Keeper protagonist is zookeeper Zeke |
