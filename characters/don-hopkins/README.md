...
| [`../will-wright/primary-sources-evidence-room.md`](../will-wright/primary-sources-evidence-room.md) | Will's curated sources map — Winograd centerpiece, Motive.c, Transmogrifier hub, full OLPC mail arc. | [`the-sims-transmogrifier-mod-tools.md`](the-sims-transmogrifier-mod-tools.md) |
...
| [`olpc-micropolis-python-pygtk.md`](olpc-micropolis-python-pygtk.md) | Python Sugar adaptor — PyGTK, Cairo, Pango shell wrapping Tcl/Tk SimCity for the XO laptop. | [`teaching-complicated-systems-without-a-manual.md`](teaching-complicated-systems-without-a-manual.md) |
| [`teaching-complicated-systems-without-a-manual.md`](teaching-complicated-systems-without-a-manual.md) | **Public essay (Aug 2026)** — Tade Mehl's cold-email questions on teachable humanoid UI; SimCity → PBD → MOOLLM; worth publishing. | [`canon-cant-and-teachable-worlds.md`](canon-cant-and-teachable-worlds.md) |
| [`canon-cant-and-teachable-worlds.md`](canon-cant-and-teachable-worlds.md) | Harvest of Nick Tau's Canon MUD (Aug 2026) — governance by topology, consent by state ontology, rate-limited LLM tutoring, pedagogically-bad-on-purpose language design. | [`writing/INDEX.yml`](writing/INDEX.yml) |
...
| [`repo-show-host-facet.md`](repo-show-host-facet.md) | Repo Show host facet — Repo Show, RTFR, GitHub as MMORPG; design in public without job-hunt signaling. | [`ideas.md`](ideas.md) |
