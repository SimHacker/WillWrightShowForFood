...
shotgun-blast intercut in post). See [`couple-and-solo-shows.yml#async_production`](../../process/couple-and-solo-shows.yml#async_production) · [`repo-show-branding.yml#attention_atoms`](../../process/repo-show-branding.yml#attention_atoms).

| # | Atom | What |
|---|------|------|
| 1 | *The Americans* **ARPANET** | Professor explains the network; camera pans up to **PDP-10** — "It's like God." Gets the ball rolling. [`cultural_excerpts#americans_arpanet_pdp10`](../../process/repo-show-branding.yml#cultural_excerpts#americans_arpanet_pdp10) |
