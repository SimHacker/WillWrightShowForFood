# Literate Programming — site quotes harvest

*Source: [http://literateprogramming.com/](http://literateprogramming.com/) (saved 2026-07-19). Companion room: [`adventure-knuth/`](adventure-knuth/).*
...
Some of my favorite tools areCWEB andLeo for source code outlining,doxygen for API documentation,CCCC andLocMetrics for source code metrics,PC Lint for static error analysis,Response Time Tracker for algorithm performance analysis, andcppunit for automated unit testing.
