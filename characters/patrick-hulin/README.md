...
simulation spec, then reimplemented it **tick-for-tick in TypeScript** — byte-identical to the
original on every tick, verified by replaying captured gameplay traces — and added real-time
multiplayer and a build-a-grid UI. Live at **[towers.world](https://towers.world)**; open source as
