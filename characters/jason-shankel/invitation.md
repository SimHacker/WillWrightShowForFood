---
status: draft
character_id: jason-shankel
public: true
consent: not_yet_asked
show_seed: repo-shows/jason-shankel/
---

# Repo Show invitation — Jason Shankel

*Jason Shankel may edit, decline, delay, or request removal at any time — or take direct edit access. [Portrayal standards](https://github.com/SimHacker/WillWrightShowForFood/blob/main/schemas/portrayal-standards.md) — also covers quiet mode and onboarding.*
