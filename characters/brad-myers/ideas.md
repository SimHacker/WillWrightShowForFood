# Ideas to explore with Brad A. Myers 👤

*Conversation hooks for a Repo Show — **Don's proposed topics**, each grounded in Brad's
public work and documented connections to this repository. Things Don would love to follow
**with** Brad A. Myers; not quotes, not claims about what they think.*
...
Pair seed: [The Two Catalogs](../../repo-shows/brad-and-edd-interaction-catalogs/README.md).
...
Seed: [`../../repo-shows/brad-and-roy-two-classrooms/README.md`](../../repo-shows/brad-and-roy-two-classrooms/README.md)
...
→ Pair seed: [The Two Catalogs](../../repo-shows/brad-and-edd-interaction-catalogs/brad-and-edd-interaction-catalogs.md) ([yml](../../repo-shows/brad-and-edd-interaction-catalogs/README.md))
