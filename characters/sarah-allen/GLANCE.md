...
**Who**: CoSA co-founder (**After Effects 1.0**) → first **Shockwave** player → **Flash
Video / FMS** from inception → **OpenLaszlo** architect + **Laszlo Webtop** → RailsBridge /
...
Read next: [README](README.md) → [ideas](ideas.md) → [invitation](invitation.md)
