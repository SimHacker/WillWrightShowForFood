...
optional_solo_show: repo-shows/scott-kim/
...
- **Inversions, live** — design an ambigram on air. You pioneered the craft (with John Langdon; the term your
  friend **Hofstadter** coined), and it turns out to be the *visual* cousin of a naming idea I've been chasing:
  one figure, two co-valid readings selected by how you look at it.
- **Viewpoint & "visibility"** — your Stanford thesis that the screen's pixels **are** the program state, no
  hidden variables. It's deep kin to pie menus, Bret Victor, and direct manipulation — and to how this repo
...
| --- | --- |
| **You (Scott)** | Ambigrams / inversions live; Viewpoint thesis (pixels *are* the state); the designed "aha" |
| **Amy Jo** | Game Thinking; community lifecycle (visitor → novice → regular → leader → elder); community without extraction |

Amy Jo is getting her own invitation today — personalized to her, about this same show. No need to
...
angles. **Read either or both** before you reply — including how **Amy Jo** describes her side.
...
**Zero homework — as much *homefun* as you are up to.** I do the setup; what we record and publish is entirely your call. **Your response:**
