---
status: memorial
character_id: jean-piaget
public: true
mode: represent_and_discuss
---

# In memoriam — Jean Piaget (1896–1980)
...
*develops*. He described cognitive growth as a sequence of **stages** (sensorimotor → preoperational
→ concrete operational → formal operational) and gave us the working vocabulary of learning —
**schemas**, **assimilation**, **accommodation**, **equilibration**, object permanence,
conservation. His **constructivism** held that a child is not an empty vessel to be filled but an
...
*This is a collaborative memorial, not a signed work. Those who knew Jean or his work are warmly invited to edit, correct, and add their own memories, documents, and stories whenever they're ready.*
