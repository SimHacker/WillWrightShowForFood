...
we record. Format flexible: **Caffeine / liveness solo**, the
**[OpenLaszlo reunion → Declare](https://github.com/SimHacker/WillWrightShowForFood/blob/main/repo-shows/openlaszlo/README.md)**
(prototypes + live objects with Ungar / Brad Myers / Temkin), memorial arc, or whatever works.
...
## Option B — Solo: Caffeine / Keep / Cursor vs liveness
...
## Option C — Remembering Vanessa — with Dan and Alan

I'd be honored to remember **Vanessa Freudenberg** **with you** — you were great friends; her
**SqueakJS** is the foundation Caffeine stands on; her **sharp WASM insights** after SqueakJS are
the thread you carried into Caffeine and Catalyst. I'm **warmly inviting Dan Ingalls and Alan Kay**
to join this memorial arc too — not as a panel ambush, but as friends who knew her work and loved
the same live-object lineage. One anchor episode with you; linked segments with them if they're
willing — or we start with just us and leave the door open.
...
Reunion-only, Caffeine-only, memorial-only, shorter call, or "not now" — all honored.
