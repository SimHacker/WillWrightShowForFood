...
Yoot, on air, about **anything and everything** he likes — his sim toys, Seaman, the craft of
designing a world. No agenda required.
...
Yoot Tower is in a delayed/unknown state due to licensing, so we discuss it **in the abstract, with
no promises**: emulation, adaptation + quality-of-life + a possible Steam release (stakeholders
permitting), or designing a whole new clean simulator **with** Yoot — tower, boat (YOOT BOOT),
cruise liner, spaceship, submarine. *He designs it with us; we code it for him.* Details and the
private-materials handling policy: [`yoot-tower-discussion.yml`](../../characters/yoot-saito/yoot-tower-discussion.yml).
