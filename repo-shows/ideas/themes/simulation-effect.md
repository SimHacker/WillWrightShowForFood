...
| Theme | Link |
|-------|------|
| Microworld morality | [microworld-morality.md](microworld-morality.md) — Cyberiad thread in the SimCity section |
| Data portability | [data-portability-crown-jewel.md](data-portability-crown-jewel.md) — the 1996 goal the effect hangs on |
| Procedural rhetoric | [procedural-rhetoric.md](procedural-rhetoric.md) — objects argue; players narrate |

---

← [All themes](README.md) · [Ideas](../README.md) · [Will premiere](../../will-wright-premiere/README.md) · [Trails](../../../process/trails/)
