...
| Theme | Link |
|-------|------|
| Simulation effect | [simulation-effect.md](simulation-effect.md) |
| Educators' track | [educators-track.md](educators-track.md) — Lall data-lab format modernized |
| Human control | [human-control-and-authorship.md](human-control-and-authorship.md) — PITM at every membrane |
