...
the book and hardware **Don's own CAM6 emulator** follows. He invented the **block cellular
...
- **CAM-6, live** — bring up Don's CAM6 emulator and run classic rules straight from the book.
