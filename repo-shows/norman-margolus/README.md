...
- **CAM-6, live** — Don's CAM6.js: **C + Mitch Bradley's Sun Forth** compiled book rules → lookup
  tables; JS **imported those tables**, then rewrote rules + compiler in JS. Classic rules from the book.
