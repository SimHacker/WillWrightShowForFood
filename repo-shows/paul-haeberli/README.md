# Repo Show — Paul Haeberli 🎨🖥️✨

> *"We replace the usual user-machine dialog with a dynamic live performance that is orchestrated
> by the user."* — Paul Haeberli, ConMan abstract, SIGGRAPH **1988**

**Guest:** [Paul Haeberli](../../characters/paul-haeberli/README.md) — SGI graphics researcher
...
1. **ConMan on air** — the 1988 paper whose abstract is this show's thesis; then walk the [patch-cord trail](../../process/trails/visual-programming-patch-cord.md).
