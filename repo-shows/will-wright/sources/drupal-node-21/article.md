...
*Submitted by Don Hopkins · Thu, 2004-02-05 22:30*
*Tags: Character Animation*
*Source: <http://www.donhopkins.com/drupal/node/21>*
...
transformedVertices[blendData[i].otherVertexIndex] = Blend( transformedVertices[blendData[i].otherVertexIndex], transformedVertices[i+textureVertexCount], weight)
