...
- [`../simcity-open-source-saga/`](../simcity-open-source-saga/) — Gilmore → Will → Rod same month  
...
- [x] DUX contracts — published in [`characters/don-hopkins/career/contracts/`](../../../../characters/don-hopkins/career/contracts/)
- [ ] Exhibit A excerpt article from [`olpc-ea-contract.pdf`](../../../../characters/don-hopkins/career/contracts/olpc-ea-contract.pdf)
