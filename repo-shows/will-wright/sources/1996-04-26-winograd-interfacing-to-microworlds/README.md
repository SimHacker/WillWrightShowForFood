...
- **The simulation effect / story as medium** — players narrate causal chains Will *knows* don't exist; "they're using it as a medium to tell stories." (Don's line, on camera.) → this is also WHY the Repo Show works: a medium for telling creators' stories.
