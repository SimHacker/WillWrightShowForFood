...
- Guru / SC3K 3D context (why Maxis needed EA): [`../2026-simcity-3000-3d-preservation/`](../2026-simcity-3000-3d-preservation/)

---

## Gaps

- [x] DUX/Don + DUX/Maxis contracts — [`characters/don-hopkins/career/contracts/`](../../../../characters/don-hopkins/career/contracts/)
- [x] EA↔OLPC PDF — `olpc-ea-contract.pdf` in contracts/
- [x] Transmogrifier **EA Tools EULA** — [`transmogrifier-ea-tools-eula.txt`](../../../../characters/don-hopkins/career/contracts/transmogrifier-ea-tools-eula.txt)
- [x] Jan–May 2007 OLPC threads → [status](../2007-01-10-simcity-for-olpc-status/) · [QA VM](../2007-01-29-olpc-simcity-ea-qa-vm/) · [pre-contract QA](../2007-05-03-olpc-simcity-pre-contract-qa/)
- [ ] Don: **distributor agreement** (separate from EULA) · name **EA executive** who flipped — see [micropolis-saga-don-draft](../micropolis-saga-don-draft/)
