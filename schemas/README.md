...
| [`audience-character.yml`](audience-character.yml) | Self-authored TicketPR MOOLLM characters — per show, not guest portrayal | [`../repo-shows/_TEMPLATE/audience/`](../repo-shows/_TEMPLATE/audience/) |
| [`fictional-audience.yml`](fictional-audience.yml) | Sims characters, repo bots, tool-ghosts — ethics for seeded fictional TicketPRs | [`../repo-shows/will-wright/audience/`](../repo-shows/will-wright/audience/) |
...
| [`language-plugin.yml`](language-plugin.yml) | Base for pluggable audience languages — drop a `language-*` in; Don auto-discovers + translates | [`../characters/don-philahue/`](../characters/don-philahue/) |
| [`language-simlish.yml`](language-simlish.yml) | Simlish (all Sims) — spoken-rendering; origins (Kearin/Lawlor) | audience `questions.yml` |
| [`language-palm-emoji.yml`](language-palm-emoji.yml) | Palm's Emoji Soul Tongue — dense glyphs; links into MOOLLM | [`palm/`](../repo-shows/will-wright/audience/palm/) |
...
| [`../process/repo-show-regulars.yml`](../process/repo-show-regulars.yml) | Cross-show balcony regulars + recurring audience mascots | [`../repo-shows/will-wright/audience/`](../repo-shows/will-wright/audience/) |
