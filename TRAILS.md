...
Playlists ([**entryways**](process/entryways/README.md)) are **ordered tours**. Trails are **thematic graphs** — jump when one topic hooks you mid-read.

**Girder:** [`process/cross-links.yml`](process/cross-links.yml) · **Playlists:** [`ENTRYWAYS.md`](ENTRYWAYS.md)
...
| Archivist / historian | [archivist](process/entryways/archivist.md) |
| HTTP bot (self-aware) | [for-bots](process/entryways/for-bots.md) · [FOR-BOTS.md](FOR-BOTS.md) |
| Full map | [Museum map](process/entryways/README.md) · [Rooms](process/entryways/rooms.md) |
